...
- `https://stat220-w26.github.io/data/data-4.csv`

- `https://stat220-w26.github.io/data/tricky-1.csv`
...
```{r}
sales <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1NN2S7bHSQbiHgd6gJnMUoJ6_eB-YgqLi_JXckFzTkbc/edit?usp=sharing", 
                                   skip = 4, 
                                   col_names = c("id", "n"))
```
