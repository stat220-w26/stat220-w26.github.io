...
Start by downloading [`24-reactivity.R`](https://stat220-w26.github.io/files/24-reactivity.R) (clicking the link will download the .R file)
...
Return to the `manager_survey` app from last time (you can either continue to work on yours or [download](/files/app-w26-sol.R) a version with the tweaks added already). Add a reactive expression to `filter()` the dataset and create the outputs. 
