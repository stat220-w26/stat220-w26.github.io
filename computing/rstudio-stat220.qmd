...
-   **stat220** folder
    -   **Assignments subfolder:** This folder will contain subfolders for each assignment. Each assignment subfolder (e.g. homework1, homework2, ...) will be a Github connected RStudio project that you will create **once an assignment is posted.**

    -   **Activities subfolder:** This folder should be used to save any non-assignment files (e.g. slides, examples) for this class. You will create this subfolder by creating an RStudio project (see step 5 below).
...
knitr::include_graphics("images/maize_files.png")
```
...
knitr::include_graphics("images/maize_newdirectory.png")
knitr::include_graphics("images/maize_newdirectory2.png")
```

-   **c.** Enter **activities** as the **Directory name** and use the **Browse** button to find your **stat220** folder. Then click **Create Project**.

```{r echo=FALSE, fig.align='center', out.width='50%'}
knitr::include_graphics("images/maize_create.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("images/maize_Rproj.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("images/maize_content.png")
```

Running R from an RStudio project sets your **working directory** to the project folder:

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("images/maize_getwd.png")
```
