...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1gppV4Mk0-6cwL_RldZ2w3U30o173Uj908uFGSEtfR64/edit?usp=sharing")
```
...
d |>
  ...
  rowwise() |>
  mutate(materials = ifelse(date <= today() + days(1), materials, "tbd")) |>
  gt() |>
