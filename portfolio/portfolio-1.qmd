...
Each of the two questions you come up with should involve more than two variables to answer. You should phrase them in a way that the is within the scope of inference of your data. For example, if you have an observational dataset, you shouldn’t phrase your question in a causal way.

This should not be long! If rendering to a PDF, I expect the entire report to be <3 pages. 
...
For more information about the variables in the dataset, see the [TidyTuesday repo page](). For more information about the data itself and an example analysis, see the [*Can't get much higher](https://www.cantgetmuchhigher.com/p/the-greatest-two-hit-wonders) newsletter. 
...
For more information about the variables in the dataset, see the [TidyTuesday repo page](https://github.com/rfordatascience/tidytuesday/blob/main/data/2025/2025-05-06/readme.md). For more information about the data itself, see [BeachWatch](https://www.beachwatch.nsw.gov.au/whatIsBeachwatch/aboutBeachwatch). 
