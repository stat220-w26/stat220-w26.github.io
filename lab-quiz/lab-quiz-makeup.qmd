...
All skills from the first 3 lab quizzes are "fair game" for this makeup, along with the following additional topics: 

## APIs and Web Scraping

- Know and explain the difference between using an API and web scraping
- Read *simple* {httr} requests and identify specific portions
- Explain HTML scraping code
