...
# Chloropleth Maps in detail {.maize}
...
::: {.task .nonincremental}
Improve this graph by: 

- Choose a different variable in `acs_state_data` to map to `fill`
- Choose a different color scale
- Update the title, axis labels, and legend title
:::
...
{{< video https://www.youtube.com/watch?v=vVX-PrBRtTY
    title="West Wing: Gall-Peters Projection"
    start="45"
    width="100%" 
    height="100%">}}
