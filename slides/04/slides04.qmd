...
2.  Find the `.rmd` template for today at the course website
3.  Choose your favorite way to open it up in maize/Rstudio
4.  Work with a neighbor to recreate this graph --\> (use 15 bins)
:::
::::
...
::: aside
To see all the options built into R (or add-on packages): [Color Palette Finder](https://r-graph-gallery.com/color-palette-finder)
:::
...
![](../img/fuel_standards_distortion.png){fig-align="center"}
...
![](../img/monachalabi-vacation-1.png)

![](../img/monachalabi-vacation-2.png)

![](../img/monachalabi-vacation-3.png)
