...
```{r}
desserts <- read_csv("https://stat220-w26.github.io/data/desserts.csv")
desserts
```
...
::: {.task .nonincremental}
Read in the file at `https://docs.google.com/spreadsheets/d/1NN2S7bHSQbiHgd6gJnMUoJ6_eB-YgqLi_JXckFzTkbc/edit?usp=sharing`.
:::
