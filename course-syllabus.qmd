...
|              | aluby\@carleton.edu                                  |            |
+--------------+------------------------------------------------------+------------+
| Office Hours | Mon 1:30-2:30 \| Tues 3-4 \| Wed 12:30-1:30 \| Fri 10-11 (appt) | CMC 307    |
|              |                                                      |            |
|              | By appt through my Google Calendar                   |            |
+--------------+------------------------------------------------------+------------+
| Website      | github.com/stat220-w26                              |            |
+--------------+------------------------------------------------------+------------+
| Texts        | *R for Data Science* (2nd Ed)                        |            |
|              |                                                      |            |
...
Part of being proficient in data science is being able to do basic data analysis "on the fly", without access to class resources. There will be 3 short (\~30 minute) in-class, paper lab quizzes to assess your ability to recall concepts and describe basic data analysis tasks. I recognize that this won't always map closely to other things we do in this class, so you'll also have the opportunity to retake quizzes.
...
## What if I miss an in-person lab quiz? 

If you need to miss a lab quiz due to a planned conflict, please make arrangements with me at least two weeks in advance. If you must miss a lab quiz due to an illness or last-minute emergency, you must notify me in advance of the quiz to arrange an alternative time. If you do not notify me in advance, you will earn 0/10 points on the in-class portion, but can still submit the revision as usual.

## Tokens

-   Turning in a token provides either (a) a 72-hour extension on a homework assignment, (b) a revision on a portfolio project, or (c) a retake of a lab quiz
